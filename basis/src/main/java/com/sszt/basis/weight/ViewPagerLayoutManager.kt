...
class ViewPagerLayoutManager : LinearLayoutManager {
    private val TAG = ViewPagerLayoutManager::class.java.simpleName
    ...
    override fun onScrollStateChanged(state: Int) {
        ...
        when (state) {
            ...
            RecyclerView.SCROLL_STATE_SETTLING -> {
                ...
                Log.e(TAG, "onScrollStateChanged:   else $state")
            }
        }
    }
...
class SquarePagerSnapHelper : PagerSnapHelper() {
    ...
    private var horizontallyHelper: OrientationHelper? = null
    ...
    override fun calculateDistanceToFinalSnap(
        ...
        if (layoutManager.canScrollHorizontally()) {
            out[0] = distanceToStart(targetView, getHorizontallyHelper(layoutManager))
        } else {
            out[0] = 0
        }
        return out
    ...
    private fun getHorizontallyHelper(
        layoutManager: RecyclerView.LayoutManager
    ): OrientationHelper {
        if (horizontallyHelper == null) {
            horizontallyHelper = OrientationHelper.createHorizontalHelper(layoutManager)
        }
        return horizontallyHelper!!
    }
