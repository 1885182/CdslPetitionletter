...
//    private boolean mFullscreenEnabled = false;
    ...
    private void initControllerView(View v) {
        ...
        lock = v.findViewById(R.id.center_play_lock);
    ...
    private OnClickListener mLock = new OnClickListener() {
        public void onClick(View v) {
            isLock = !isLock;
            if (isLock) {
                lock.setImageResource(R.drawable.ic_player_lock_close);
                hide();
            } else {
                lock.setImageResource(R.drawable.ic_player_lock_open);
                show();
            }
...
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateBackButton() {
        ...
        lock.setVisibility(mIsFullScreen ? View.VISIBLE : View.INVISIBLE);
    }
