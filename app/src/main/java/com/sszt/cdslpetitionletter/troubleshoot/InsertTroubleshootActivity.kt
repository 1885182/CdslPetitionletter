...
import com.sszt.cdslpetitionletter.databinding.ActivityInsertTroubleshootBinding
 ...
 * 信访隐患排查-新增
 */
@Route(path = IRoute.troubleshooting_insert)
class InsertTroubleshootActivity : BaseActivity<PublicViewModel,ActivityInsertTroubleshootBinding>() {


    override fun layoutId() = R.layout.activity_insert_troubleshoot
